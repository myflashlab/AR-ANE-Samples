package samples {
	 ...
	 */
	public class SampleLocationBased extends Sprite 
	{
		...
		public function SampleLocationBased():void 
		{
		...
		private function init():void
		{
			...
			var src:File = File.applicationDirectory.resolvePath("SampleLocationBased");
			var dis:File = File.documentsDirectory.resolvePath("MyAR/SampleLocationBased");
			...
			function startAR(e:MouseEvent):void
			{
				if (_isCopyDone)
				{
					C.log("startAR = ", _ex.startAR("/MyAR/SampleLocationBased/content/index.xml", true)); // make sure you are starting with the initial slash at the begining!
				}
				else
				{
