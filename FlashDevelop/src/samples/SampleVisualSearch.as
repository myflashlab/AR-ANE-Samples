package samples {
	...
	/**
	 * 
	 * @author Hadi Tavakoli - 5/4/2015 9:41 AM
	 */
	public class SampleVisualSearch extends Sprite 
	{
		...
		public function SampleVisualSearch():void 
		{
		...
		private function init():void
		{
			...
			// learn about the rest API for managing the trackables on server: http://dev.metaio.com/visual-search/rest-api/
			...
			var src:File = File.applicationDirectory.resolvePath("SampleVisualSearch");
			var dis:File = File.documentsDirectory.resolvePath("MyAR/SampleVisualSearch");
			...
			function startAR(e:MouseEvent):void
			{
				if (_isCopyDone)
				{
					C.log("startAR = ", _ex.startAR("/MyAR/SampleVisualSearch/content/index.xml", true)); // make sure you are starting with the initial slash at the begining!
				}
				else
				{
