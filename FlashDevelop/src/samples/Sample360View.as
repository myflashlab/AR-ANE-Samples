package samples {
	...
	/**
	 * 
	 * @author Hadi Tavakoli - 4/16/2015 11:44 AM
	 */
	public class Sample360View extends Sprite 
	{
		...
		public function Sample360View():void 
		{
		...
		private function init():void
		{
			...
			var src:File = File.applicationDirectory.resolvePath("Sample360View");
			var dis:File = File.documentsDirectory.resolvePath("MyAR/Sample360View");
			...
			function startAR(e:MouseEvent):void
			{
				if (_isCopyDone)
				{
					C.log("startAR = ", _ex.startAR("/MyAR/Sample360View/content/index.xml", true)); // make sure you are starting with the initial slash at the begining!
				}
				else
				{
